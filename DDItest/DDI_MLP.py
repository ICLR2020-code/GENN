...
import numpy as np
from sklearn.metrics import average_precision_score, f1_score, accuracy_score, precision_recall_fscore_support, roc_auc_score

from torch_geometric.data import Data, DataLoader
# from torch_geometric.utils import remove_self_loops
from torch_geometric.read.ddi import read_ddi_data

from torch_geometric.nn.models.model_DDINet import DDIDecoder, DDINet, DDIEncoder, DDI_MLP
import warnings
...
model_save_path = osp.join(osp.dirname(osp.realpath(
    __file__)), '../saved_models/', 'MLP_dataset_{}_seed_{}_ratio_{}'.format(args.data_prefix, args.seed, args.data_ratio))
...
def conflict_pair_cnt(val_data):
...
def pairwise_correlation(val_data):
    model.eval()
